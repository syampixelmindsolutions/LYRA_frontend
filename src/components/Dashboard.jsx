...
// const BANNERS = [
//   { id: 1, title: "New Season Arrivals", subtitle: "Up to 50% OFF on Premium Fashion", cta: "Shop Now",  img: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=800&q=80", from: "from-purple-900", via: "via-violet-800", to: "to-purple-600" },
//   { id: 2, title: "Luxury Watches",      subtitle: "Timeless pieces for every occasion",  cta: "Explore",   img: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=800&q=80", from: "from-slate-900", via: "via-blue-900",   to: "to-blue-700" },
//   { id: 3, title: "Exclusive Footwear",  subtitle: "Walk in style with our latest drops",  cta: "Discover",  img: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800&q=80", from: "from-stone-900", via: "via-amber-900",  to: "to-amber-700" },
// ];
...
//             <button className="flex flex-col items-center px-3 py-1.5 text-white/70 hover:text-white hover:bg-white/10 rounded-lg transition-all text-xs gap-0.5 relative"
...
//               {showMenu && (
//                 <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl shadow-xl shadow-purple-100 border border-purple-50 overflow-hidden z-50 animate-fade-in">
...
//                   </div>
//                   {["📦 My Orders", "👤 My Profile", "♡ Wishlist", "📍 Addresses"].map((item) => (
//                     <button key={item} className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-purple-50 hover:text-violet-700 transition-colors">
//                       {item}
//                     </button>
//                   ))}
...
//             className={`flex flex-col items-center px-5 py-2.5 text-xs font-medium flex-shrink-0 border-b-2 transition-all gap-1 ${activeTab === "All" ? "border-violet-600 text-violet-700" : "border-transparent text-gray-500 hover:text-violet-600 hover:bg-violet-50"}`}
//           >
...
//         <div className={`relative rounded-2xl overflow-hidden mb-8 h-72 bg-gradient-to-r ${banner.from} ${banner.via} ${banner.to} shadow-xl flex`}>
...
//             <button className="w-fit px-7 py-3 bg-white text-[#1e0a3c] text-sm font-semibold rounded-xl hover:bg-violet-100 transition-all hover:-translate-y-0.5 hover:shadow-lg">
//               {banner.cta} →
//             </button>
//             {/* Dots */}
...
//             {activeTab === "All" ? <>New <span className="text-violet-600">Arrivals</span></> : <>{activeTab} <span className="text-violet-600">Collection</span></>}
//           </h2>
...
//             {filtered.map((p) => (
//               <ProductCard key={p.id} product={p} onAddToCart={setModalProduct} />
//             ))}
//           </div>
//         ) : (
...
//       {/* Footer */}
//       <footer className="bg-[#1e0a3c] mt-16 px-8 py-8 flex items-center justify-between">
//         <span className="font-serif text-xl tracking-widest text-purple-300">LYRA</span>
//         <span className="text-xs text-white/30">© 2025 Lyra. All rights reserved.</span>
//       </footer>
